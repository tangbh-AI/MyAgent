...
D = 500.0         # 外径 (mm)
t = 5.0           # 壁厚 (mm)
r_mid = (D - t) / 2.0  # 中面半径 (mm)

# 材料参数
E_mod = 210000.0           # 弹性模量 (MPa)
nu = 0.3                   # 泊松比
rho = 7800e-12             # 密度 (ton/mm³) = 7800 kg/m³
# 7800 kg/m³ = 7800 * 1e-9 ton/mm³ = 7.8e-9 ton/mm³
# 使用 7800e-12? 7800e-9 = 7.8e-6? 让我们正确计算：
# 1 ton = 1000 kg, 1 m³ = 1e9 mm³, 所以 7800 kg/m³ = 7800/1e9 ton/mm³ = 7.8e-6 ton/mm³? 不对，7800/1e9 = 7.8e-6。这似乎太大了。
# 重新算：1 kg/m³ = 1e-9 ton/mm³? 1 kg = 0.001 ton, 1 m³ = 1e9 mm³, 所以 1 kg/m³ = 0.001 ton / 1e9 mm³ = 1e-12 ton/mm³。
# 因此 7800 kg/m³ = 7800 * 1e-12 = 7.8e-9 ton/mm³。
rho = 7.8e-9  # ton/mm³
...
# ---------- 创建部件（壳）----------
# 中面圆草图（XY平面）
sketch = model.ConstrainedSketch(name='TubeProfile', sheetSize=2.0 * L)
...
material.Elastic(table=((E_mod, nu), ))
...
# 全局种子
part.seedPart(size=20.0)   # 单元尺寸约 20 mm
part.generateMesh()
